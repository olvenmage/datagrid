...
class Datagrid
{
    ...
    /**
     * Rendered script will be stored here
     *
     * @var string
     */
    private $script;
     ...
     * @return string
     */
    public function getScriptViewPath()
    {
        return __DIR__ . '/views/script.phtml';
    }  
    ...
    public function renderScript()
    {
        ...
        ob_start();
        require $this->getScriptViewPath();
    ...
    {
        if (!is_string($this->html) || !is_string($this->script)) {
            return '';
        }
